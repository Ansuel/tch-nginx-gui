...
--- Function to retrieve minimal adslMib info.
-- To improve performance we only update the data after
-- 5 seconds between two consecutive calls.
-- @param lineid Line number.
-- @return sets global adslMib variable.
...
local function getInfoValueFromAdslMib(lineid, key, subkey)
  ...
  if key == "maxrate" or key == "currentrate" then
    getMinimalDSLStatistics(lineid)
  else
    getAdslMibInfo(lineid)
  end
...
local function getStatsValuesFromAdslMib(lineid)
  ...
  addAdslMibValue(
    ...
    t["currentquarter"],
    "ses",
    "QuarterHourSeverelyErroredSecsDs",
    "QuarterHourSeverelyErroredSecsUs"
  )
  ...
  addAdslMibValue(
    ...
    t["currentquarter"],
    "lof",
    "QuarterHourLossOfFramingSecsDs",
    "QuarterHourLossOfFramingSecsUs"
  )
  ...
  addAdslMibValue(
    ...
    t["previousquarter"],
    "fec",
    "PreviousQuarterHourXTURFECErrors",
    "PreviousQuarterHourXTUCFECErrors"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "crc",
    "PreviousQuarterHourXTURCRCErrors",
    "PreviousQuarterHourXTUCCRCErrors"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "hec",
    "PreviousQuarterHourXTURHECErrors",
    "PreviousQuarterHourXTUCHECErrors"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "es",
    "PreviousQuarterHourErroredSecsDs",
    "PreviousQuarterHourErroredSecsUs"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "ses",
    "PreviousQuarterHourSeverelyErroredSecsDs",
    "PreviousQuarterHourSeverelyErroredSecsUs"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "uas",
    "PreviousQuarterHourUnavailableSecsDs",
    "PreviousQuarterHourUnavailableSecsUs"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "los",
    "PreviousQuarterHourLossOfSignalSecsDs",
    "PreviousQuarterHourLossOfSignalSecsUs"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "lof",
    "PreviousQuarterHourLossOfFramingSecsDs",
    "PreviousQuarterHourLossOfFramingSecsUs"
  )
  addAdslMibValue(
    adslMib,
    t["previousquarter"],
    "lom",
    "PreviousQuarterHourLossOfMarginSecsDs",
    "PreviousQuarterHourLossOfMarginSecsUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "ses",
    "LastShowtimeSeverelyErroredSecsDs",
    "LastShowtimeSeverelyErroredSecsUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "lof",
    "LastShowtimeLossOfFramingSecsDs",
    "LastShowtimeLossOfFramingSecsUs"
  )
  ...
  addAdslMibValue(
    ...
    t["previousday"],
    "ses",
    "PreviousDaySeverelyErroredSecsDs",
    "PreviousDaySeverelyErroredSecsUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "bswCompleted",
    "LastShowtimeBSWCompletedDs",
    "LastShowtimeBSWCompletedUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "sraCompleted",
    "LastShowtimeSRACompletedDs",
    "LastShowtimeSRACOmpletedUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "fraCompleted",
    "LastShowtimeFRACompletedDs",
    "LastShowtimeFRACompletedUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "rpaCompleted",
    "LastShowtimeRPACompletedDs",
    "LastShowtimeRPACompletedUs"
  )
  ...
  addAdslMibValue(
    ...
    t["lastshowtime"],
    "tigaCompleted",
    "LastShowtimeTIGACompletedDs",
    "LastShowtimeTIGACompletedUs"
  )
...
local function getNLNMInfo(lineid)
  ...
  nlnm["ThresholdNumberOfBins"] =
    nlnmData["ThresholdNumberOfBins"] and tostring(nlnmData["ThresholdNumberOfBins"]) or "0"
...
local function getBridgeTapDetectionInfo(lineid)
  ...
  bridgeTap["BridgeTapDetected"] =
    bridgeTapData["BridgeTapDetected"] and tostring(bridgeTapData["BridgeTapDetected"]) or "0"
  bridgeTap["LocalMinimumTone"] =
    bridgeTapData["LocalMinimumTone"] and tostring(bridgeTapData["LocalMinimumTone"]) or "0"
  bridgeTap["BridgeTapDistance"] =
    bridgeTapData["BridgeTapDistance"] and tostring(bridgeTapData["BridgeTapDistance"]) or "0"
...
function M.isBondingSupported()
  local supported =
    uci_helper.get_from_uci({config = "xdsl", sectionname = "dsl0", option = "bondingsupport", default = "0"})
  if supported == "1" then
    return true
  end
  return false

...
if datatype and datatype== "xdsl" then
	...
	local wan_uptime = post_helper.secondsToTimeShort(content_rpc["wan_uptime"]) or nil
	...
	uptime_text = wan_uptime and format(T"Uptime" .. ": <strong>%s</strong>",post_helper.secondsToTimeShort(wan_uptime)) or "",
	wan_uptime = wan_uptime or "",

...
-- When both xdsl and ethwan is connected and when eth3 is unplugged
-- eth3_down event will be received from the net link
-- however since xdsl is present, the internet LED behavior must not be modified
-- this is exceptional to few scenarios where eth3 is used as LAN/WAN port
-- hence always check the xdsl status before acting on the eth3_down event
...
stateMachines = {
    ...
    broadband = {
        ...
        actions = {
            idling = {
                netdevLed("broadband:green", 'eth3', 'link'),
            },
            training = {
                staticLed("broadband:green", false)
            },
    ...
    internet = {
        ...
        transitions = {
            ...
            internet_connecting = {
                ...
                network_device_eth3_down = internet_nextState,

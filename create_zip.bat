...
bash -c "cd decompressed/custom-ripdrv && tar -cf - * --owner=0 --group=0 | bzip2 -9 -c - > ../../compressed/custom-ripdrv.tar.bz2"
bash -c "rm -r total"
bash -c "mkdir total"
...
bash -c "cd total && tar -cf - * --owner=0 --group=0 | bzip2 -9 -c - > ../compressed/GUI.tar.bz2"
bash -c "./update-version.sh"
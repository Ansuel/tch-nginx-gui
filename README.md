...
<li>Install extensions like: Telstra Basic GUI, LuCI, Transmission, Aria2, Adblock, rsyncd, Ookla Speedtest, OpenSpeedTest, AdGuard Home, WireGuard and OpenVPN on TUN-capable firmware, and the legacy L2TP/IPsec VPN server</li>
